...
В коде можно включить/выключить отправку данных на ThingSpeak https://thingspeak.com/ (рекомендуется), Народный мониторинг https://narodmon.ru/ или Shopker (https://habr.com/ru/post/535158/).
